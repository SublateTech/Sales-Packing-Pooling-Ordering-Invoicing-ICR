...
Public Module AutoUpdate
    ...
    Private m_UpdateFileName As String = "SigData.txt"
    Private m_ErrorMessage As String = "There was a problem running the Auto Update."
    ...
    Public Function UpdateFiles(Optional ByVal RemotePath As String = "") As Boolean
        ...
        Try
            ...
            'MessageBox.Show(RemoteUri & UpdateFileName)
            ...
            'MessageBox.Show(Application.StartupPath.ToLower & "\" & Info(0).ToLower)
            'MessageBox.Show(Application.ExecutablePath.ToLower)

            'Dim fStatus As frmStatus
