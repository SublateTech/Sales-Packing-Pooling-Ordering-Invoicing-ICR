...
namespace Signature
{
    ...
    public class frmICR : System.Windows.Forms.Form
    {
        ...
        public class ICRProcessor
        {
            ...
            //Methods            
            public ICRProcessor(frmICR frm)
            {
                this.frm = frm;
            ...
            private void RegisterTemplate(String FormName, String TemplateName)
            {
            ...
            private void InitFormProcessing()
            {
