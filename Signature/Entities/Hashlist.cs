...
namespace Signature.Classes
{
	...
	/// 
	/// </summary>
    public class Hashlist : Company, IDictionary, IEnumerable, IList
	{

        public Hashlist(){}
        public Hashlist(String CompanyID) : base(CompanyID) {}
		...
		/// 
		/// </summary>
		public ArrayList m_oKeys = new ArrayList();
		/// <summary>
		/// 
		/// </summary>
		public Hashtable m_oValues = new Hashtable();
        ...
        {
            m_oValues.Remove(m_oKeys[index]);
            m_oKeys.Remove(m_oKeys[index]);
        }
        /// <summary>
		/// 
		/// </summary>
