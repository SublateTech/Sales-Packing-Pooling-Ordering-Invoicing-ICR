...
namespace Signature.Classes
{
	public class UpcA
	{
		...
		public void DrawUpcaBarcode( System.Drawing.Graphics g, System.Drawing.PointF pt)
		{
		...
		//	if (this.ChecksumDigit == null)
            ...
            xPosition += g.MeasureString(this.ChecksumDigit, font).Width;

            pt.X = pt.X + (xPosition- pt.X - g.MeasureString(this._Description, font).Width) / 2;
            g.DrawString(_Description, font, brush, new System.Drawing.PointF(pt.X, yPosition+ (float)0.13));
