...
namespace Signature.Classes
{
    ...
    public class PDF
    {
        ...
        public  bool ExportReport(ReportDocument crReportDocument, string ExpType, string ExportPath, string filename)
        {
        ...
        public  byte[] ExportReportToStream(ReportDocument crReportDocument, ExportFormatType exptype)
        ...
        public  string ExportReportToString(ReportDocument crReportDocument)
        {
            Stream st;
