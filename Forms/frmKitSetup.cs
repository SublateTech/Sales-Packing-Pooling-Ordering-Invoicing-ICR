...
namespace Signature.Forms
{
	...
	public sealed class frmKitSetup : System.Windows.Forms.Form
	{
        ...
        private Signature.Windows.Forms.Button btDelete;
        ...
        private void bPrint_Click(object sender, EventArgs e)
        {
            ...
            oViewReport1.SetReport((int)Report.FinalBillTally, oKit.CompanyID, txtCustomerID.Text, false);
            frmViewReport oViewReport = new frmViewReport();
            oViewReport.SetReport((int)Report.BoxInventory, oKit.CompanyID, txtCustomerID.Text, false);
