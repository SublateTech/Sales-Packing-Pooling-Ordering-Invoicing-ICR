...
namespace Signature.Forms
{
	...
	/// </summary>
	public sealed class frmPaymentProvider : frmBase
	{
		#region declarations		
        ...
        public frmPaymentProvider()
		{
			InitializeComponent();
            
            oPurchase = new Purchase(this.CompanyID);
		}
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPaymentProvider));
            ...
            this.txtDate.FormatString = "";
            this.txtDate.Location = new System.Drawing.Point(390, 81);
            this.txtDate.MaskInput = "{LOC}mm/dd/yyyy";
            ...
            this.txtPurchaseID.Location = new System.Drawing.Point(119, 24);
            this.txtPurchaseID.Name = "txtCustomerID";
            this.txtPurchaseID.Size = new System.Drawing.Size(80, 20);
            ...
            this.Name = "frmPaymentProvider";
            this.ShowInTaskbar = false;
            this.Text = "Provider Payments";
        ...
        public bool Display()
        {
            ...
            txtPurchaseID.Text = oPayment.PurchaseID;
            oPurchase.Find(oPayment.PurchaseID);
            oVendor.Find(oPurchase.VendID);
            txtName.Text = oVendor.Name;
            txtAmount.Value = oPayment.Amount > 0 ? oPayment.Amount : oPayment.Amount*-1;
