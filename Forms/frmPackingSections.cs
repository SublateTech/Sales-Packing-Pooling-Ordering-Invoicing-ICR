...
namespace Signature.Forms
{
	...
	/// </summary>
	public sealed class frmPackingSections : frmBase
	{
		#region declarations		
        ...
        public frmPackingSections()
        {
            InitializeComponent();
            oPacking = new PackingSection(base.CompanyID);
        }
        public frmPackingSections(String CustomerID, String Teacher, String Student)
        {
            InitializeComponent();
        ...
        public frmPackingSections(PackingSection _oOrder)
        {
            InitializeComponent();
            oPacking = _oOrder;
            this.CompanyID = Global.GetParameter("CurrentCompany");
		...
		private void txtCustomerID_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
		{
            ...
            if (sender==txtOrderID)	
			{
                ...
                if (e.KeyCode.ToString() == "Return" || e.KeyCode.ToString() == "Tab")
				{
                    ...
                    if (oPacking.Find(OrderID,Global.CurrrentLine,this.SectionID,true))
                    {   
                        /*
                    ...
                    if (oPacking.ScanItems.Contains(txtProductID.Text))
                    {
                        ...
                        if (oPacking.ScanItems[txtProductID.Text].Scanned == oPacking.ScanItems[txtProductID.Text].Quantity)
                        {
                            ...
                            if (oPacking.ScanItems.Count == 0)
                            {
                                ...
                                if (oPacking.ItHasPendingSections)
                                    oPacking.ClosePendingSections();
