...
namespace Signature
{
	...
	/// </summary>
	public class frmPrizesView : System.Windows.Forms.Form
	{
		...
		public frmPrizesView(String sCompanyID)
		{
			//
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
            ...
            dt = oMySql.GetDataView("SELECT PrizeID, Description, Prize_Break, Levels from Prizes Where CompanyID='" + sCompanyID + "'", "Prize");
			
            DataGridTableStyle TbStyle = new DataGridTableStyle();
            
            TbStyle.MappingName = "Prize";
            ...
            Col_01.HeaderText = "Prize ID";
            Col_01.MappingName = "PrizeID";
            Col_01.Width = 60;
            Col_01.NullText = "";
           ...
           DataGridTextBoxColumn Col_03 = new DataGridTextBoxColumn();
            ...
            Col_03.HeaderText = "PrizeBreak";
            Col_03.MappingName = "PrizeBreak";
            Col_03.Width = 70;
            Col_03.NullText = "";
            ...
            Col_03.HeaderText = "Levels";
            Col_03.MappingName = "Leves";
            Col_03.Width = 70;
            Col_03.NullText = "";
            Col_03.ReadOnly = true;
            ...
            TbStyle.GridColumnStyles.AddRange(new DataGridColumnStyle[] { Col_01, Col_02, Col_03, Col_04 });
