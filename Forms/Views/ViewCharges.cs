...
namespace Signature
{
	...
	/// </summary>
	public class frmChargesView : System.Windows.Forms.Form
    {
		...
		public frmChargesView(String sCompanyID, String _CustomerID)
		{
			//
        ...
        private void DataGrid_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    sSelectedID = Grid.ActiveRow.Cells["ChargeID"].Text;
