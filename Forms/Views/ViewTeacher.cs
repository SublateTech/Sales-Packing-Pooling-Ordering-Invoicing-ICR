...
namespace Signature
{
    ...
    /// </summary>
    public class frmViewTeacher : System.Windows.Forms.Form
    {
        ...
        public frmViewTeacher(String sCompanyID, String CustomerID)
        {
            //
        ...
        private void InitializeComponent()
        {
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Students", 0);
            ...
            this.Label1.Size = new System.Drawing.Size(552, 6);
            ...
            this.panel1.Size = new System.Drawing.Size(552, 614);
            ...
            this.Grid.Name = "Grid";
            this.Grid.Size = new System.Drawing.Size(537, 524);
            ...
            this.GroupBox1.Size = new System.Drawing.Size(547, 42);
            ...
            this.Label23.Size = new System.Drawing.Size(550, 10);
            ...
            this.pbar.Name = "pbar";
            this.pbar.Size = new System.Drawing.Size(551, 10);
        ...
        private void frmCustomerView_Load(object sender, System.EventArgs e)
        {
            ...
            if (CustomerID.Trim() == "")
                dt = oMySql.GetDataView(String.Format("Select distinct(Teacher), count(Student)as Students,CustomerID from {0} Where CompanyID='" + this.sCompanyID + "' Group by Teacher", "Orders"), "Teachers");
            else
                dt = oMySql.GetDataView(String.Format("Select distinct(Teacher), count(Student)as Students,CustomerID from {0} Where CompanyID='" + this.sCompanyID + "' And CustomerID='" + this.CustomerID + "' Group by Teacher", "Orders"), "Teachers");
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (Grid.Rows.Count > 0)
                    {
                        ...
                        if (Grid.ActiveRow != null)
                            sSelectedID = Grid.ActiveRow.Cells["Teacher"].Text;
                        this.Close();
