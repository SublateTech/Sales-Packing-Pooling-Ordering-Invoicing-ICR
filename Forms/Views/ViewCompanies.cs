...
namespace Signature
{
    ...
    /// </summary>
    public class frmViewCompanies : System.Windows.Forms.Form
    {
        ...
        public frmViewCompanies(Boolean All)
        {
            InitializeComponent();
            this.All = All;
        }
        ...
        private void frmCustomerView_Load(object sender, System.EventArgs e)
        {
            ...
            if (this.All)
                dt = oMySql.GetDataView("SELECT CompanyID, Name FROM Company Order By CompanyID", "Company");
            else
                dt = oMySql.GetDataView("SELECT CompanyID, Name FROM Company where IsExternal='0' Order By CompanyID", "Company");
