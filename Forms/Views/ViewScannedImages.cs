...
namespace Signature
{
	...
	/// </summary>
	public class frmViewScannedImages : System.Windows.Forms.Form
	{
		...
		private DataView dt;
		public String sSelectedID = null;
		private String sCompanyID = null;
		private String sCustomerID = null;
        
		
		public frmViewScannedImages(String sCompanyID, String CustomerID)
		{
			//
		...
		private void frmViewTeacher_Load(object sender, System.EventArgs e)
		{
            ...
            //MessageBox.Show("Select distinct(BatchID), NumberImages, StartDate, EndDate, StartImage, EndImage, Processed  from scanned_images Where CompanyID='" + sCompanyID + "' And CustomerID='" + this.sCustomerID + "' And CustomerID='" + this._Teacher + "' Group by BatchID");
			
            dt = oMySql.GetDataView("Select distinct(BatchID), Teacher, NumberImages, StartDate, EndDate, StartImage, EndImage, Processed  from scanned_images Where CompanyID='"+sCompanyID+"' And CustomerID='" + this.sCustomerID + "'  Group by BatchID", "Batches");
            ...
            Col_01.HeaderText = "Batch Number";
            Col_01.MappingName = "BatchID";
            Col_01.Width = 150;
            Col_01.NullText = "";
            ...
            Col_02.HeaderText = "Number of Images";
            Col_02.MappingName = "NumberImages";
            Col_02.Width = 80;
            Col_02.NullText = "";
