...
namespace Signature
{
	...
	/// </summary>
	public class frmVoicemailsView : System.Windows.Forms.Form
    {
        ...
        public frmVoicemailsView(String sCompanyID)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("RepID");
            ...
            ultraGridColumn1.Header.Caption = "Voicemail";
            ...
            this.Name = "frmVoicemailsView";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Charges View";
            this.TopMost = true;
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
            ...
            //dt = oMySql.GetDataView(String.Format("Select ChargeID, Comment, Date, Amount,Type  from Payment  Where CompanyID='{0}' And CustomerID='{1}' Order By Date",sCompanyID,CustomerID), "Tmp");
            dt = oMySql.GetDataView("SELECT r.RepID, rs.Name  FROM Rep r Left Join Reps rs On rs.ID=r.ID Where CompanyID='" + sCompanyID + "' order by rs.Name", "Reps");
        ...
        private void DataGrid_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    sSelectedID = Grid.ActiveRow.Cells["RepID"].Text;
