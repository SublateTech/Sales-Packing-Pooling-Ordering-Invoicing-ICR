...
namespace Signature
{
    ...
    /// </summary>
    public class frmViewTickets : System.Windows.Forms.Form
    {
        ...
        public frmViewTickets(String sCompanyID, String CustomerID)
        {
        ...
        public frmViewTickets(Order oOrder, String ProductID)
        {
            this.oOrder = oOrder;
        ...
        {
            //CONVERT(, CHAR(8)) AS ID

            Signature.Data.MySQL oMySql = Global.oMySql;

            if (this.OrderID == 0)
                dt = oMySql.GetDataView(String.Format("SELECT CONVERT(ot.OrderID, CHAR(8)) as ID, CONVERT(ot.ID, CHAR(8)) AS TicketID , o.Student, o.CustomerID FROM OrderTicket ot Left Join Orders o On o.ID=ot.OrderID Where ot.CompanyID='{0}'", this.sCompanyID), "Tickets");
            else
                dt = oMySql.GetDataView(String.Format("SELECT CONVERT(ot.OrderID, CHAR(8)) as ID, CONVERT(ot.ID, CHAR(8)) AS TicketID , o.Student, o.CustomerID FROM OrderTicket ot Left Join Orders o On o.ID=ot.OrderID Where ot.OrderID='{0}' And ot.ProductID='{1}'", this.OrderID, this.ProductID), "Tickets");
        ...
        private void menuitem3_Click(object sender, System.EventArgs e)
        {
            if (Grid.ActiveRow != null)
            {
                ...
                //oTicket.Find(Convert.ToInt32(Grid.ActiveRow.Cells["TicketID"].Text));
                //oTicket.Delete();
                Int32 _Ticket = Convert.ToInt32(Grid.ActiveRow.Cells["TicketID"].Text);
