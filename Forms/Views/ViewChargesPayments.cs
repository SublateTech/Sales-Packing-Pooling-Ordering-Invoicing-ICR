...
namespace Signature
{
	...
	/// </summary>
	public class ViewChargesPayments : System.Windows.Forms.Form
    {
        ...
        public ViewChargesPayments(String sCompanyID, String _CustomerID)
		{
			//
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
            ...
            dt = oMySql.GetDataView(String.Format("Select PaymentID, Comment, Date, Amount,Type  from PaymentProvider  Where CompanyID='{0}' And ProviderID='{1}' Order By Date",sCompanyID,CustomerID), "Tmp");
