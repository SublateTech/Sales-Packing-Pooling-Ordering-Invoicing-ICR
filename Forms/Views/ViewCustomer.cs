...
namespace Signature
{
	...
	/// </summary>
	public class frmCustomerView : System.Windows.Forms.Form
    {
		...
		public frmCustomerView(String sCompanyID)
		{
			//
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
			...
			dt = oMySql.GetDataView("SELECT CustomerID, Name, City, State from Customer Where CompanyID='"+sCompanyID+"'","Customer");
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (Grid.Rows.Count > 0)
                    {
                        ...
                        if (Grid.ActiveRow != null)
                            sSelectedID = Grid.ActiveRow.Cells["CustomerID"].Text;
                        this.Close();
