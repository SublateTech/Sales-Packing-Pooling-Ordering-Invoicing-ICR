...
namespace Signature.Forms
{
	...
	/// </summary>
	public class frmViewScannedTeachers : System.Windows.Forms.Form
    {
        ...
        public frmViewScannedTeachers(String CompanyID, String CustomerID)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("BatchID");
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Teacher", 0);
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Corrected", 3);
            ...
            this.Label1.Size = new System.Drawing.Size(584, 6);
            ...
            this.GroupBox1.Size = new System.Drawing.Size(573, 42);
            ...
            this.Label23.Size = new System.Drawing.Size(584, 10);
            ...
            this.pbar.Name = "pbar";
            this.pbar.Size = new System.Drawing.Size(576, 10);
            ...
            this.Grid.Name = "Grid";
            this.Grid.Size = new System.Drawing.Size(572, 448);
            ...
            this.Name = "frmViewScannedTeachers";
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
			...
			if (this.CustomerID.Trim() == "")
                dt = oMySql.GetDataView(String.Format("Select CustomerID,Teacher, BatchID, Scanned from {0} Where CompanyID='" + this.CompanyID + "'" , "OrderScanned"), "Teachers");
            else
                dt = oMySql.GetDataView(String.Format("Select CustomerID,Teacher, BatchID, Scanned from {0} Where CompanyID='" + this.CompanyID + "' And CustomerID='" + this.CustomerID + "' ", "OrderScanned"), "Teachers");
