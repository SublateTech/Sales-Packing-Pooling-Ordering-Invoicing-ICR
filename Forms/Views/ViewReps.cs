...
namespace Signature
{
	...
	public class frmViewReps : System.Windows.Forms.Form
	{
		...
		private DataView dt;
		public Int32 sSelectedID = 0;
        private Boolean Active = false;
		//private String sCompanyID = "";
		//private String sCustomerID = "";
        private String _CompanyID = null;
		
		public frmViewReps(String CompanyID, Boolean Active
            )
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.DataGrid.Size = new System.Drawing.Size(435, 370);
            ...
            this.Label1.Size = new System.Drawing.Size(447, 6);
            ...
            this.GroupBox1.Size = new System.Drawing.Size(431, 42);
            ...
            this.btnClose.Location = new System.Drawing.Point(353, 11);
            ...
            this.Label23.Size = new System.Drawing.Size(447, 10);
            ...
            this.lstView.Location = new System.Drawing.Point(-133, 462);
		...
		private void frmViewTeacher_Load(object sender, System.EventArgs e)
		{
			...
			if (Active)
                dt = oMySql.GetDataView("SELECT r.ID, rs.RepID, r.Name  FROM Reps r Left Join Rep rs On rs.ID=r.ID And CompanyID='" + _CompanyID + "' Where r.ViewList='1' Order By r.Name", "Rep");
            else
                dt = oMySql.GetDataView("SELECT r.ID, r.RepID, rs.Name  FROM Rep r Left Join Reps rs On rs.ID=r.ID Where CompanyID='" + _CompanyID + "' Order By rs.Name", "Rep");    
            ...
            DataGridTextBoxColumn Col_00 = new DataGridTextBoxColumn();

            Col_00.HeaderText = "Rep ID";
            Col_00.MappingName = "ID";
            Col_00.Width = 80;
            Col_00.NullText = "";
            Col_00.ReadOnly = true;
            
            
            DataGridTextBoxColumn Col_01 = new DataGridTextBoxColumn();
             
            Col_01.HeaderText = "Ext";
            ...
            TbStyle.GridColumnStyles.AddRange(new DataGridColumnStyle[] { Col_00, Col_01, Col_02 });
		...
		{
			sSelectedID = Convert.ToInt32(DataGrid[DataGrid.CurrentRowIndex, 0].ToString());
			this.Close();
		}
