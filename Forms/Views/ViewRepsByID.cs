...
namespace Signature
{
	...
	public class frmViewRepsByID : System.Windows.Forms.Form
	{
   ...
   //    private String _CompanyID = null;
		...
		private void frmViewTeacher_Load(object sender, System.EventArgs e)
		{
			...
			dt = oMySql.GetDataView("SELECT ID, Name  FROM Reps Order By Name ", "Rep");
