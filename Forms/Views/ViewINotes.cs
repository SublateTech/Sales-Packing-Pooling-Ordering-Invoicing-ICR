...
namespace Signature
{
	...
	/// </summary>
	public class frmINotesView : System.Windows.Forms.Form
    {
        ...
        public frmINotesView(String sCompanyID,String _PurchaseID)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("NoteID");
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Date", 0);
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Note", 1);
            ...
            this.GroupBox1.Appearance = appearance6;
            ...
            this.GroupBox1.Size = new System.Drawing.Size(417, 24);
            ...
            this.Name = "frmINotesView";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Notes View";
            this.TopMost = true;
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
         ...
         //   String Sql = String.Format("Select PurchaseNoteID as ID, Date, Note  from PurchaseNotes  Where CompanyID='{0}' And PurchaseID='{1}'", sCompanyID, PurchaseID);
            dt = oMySql.GetDataView(String.Format("Select PurchaseNoteID as ID, DATE_FORMAT(Date,'%m/%d/%y  %H:%m:%S') as Date, Note  from PurchaseNotes  Where CompanyID='{0}' And PurchaseID='{1}'", sCompanyID, PurchaseID), "Tmp");
