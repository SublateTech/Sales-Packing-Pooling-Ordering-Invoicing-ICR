...
namespace Signature
{
    ...
    /// </summary>
    public class frmViewCardSets : System.Windows.Forms.Form
    {
        ...
        private void frmCustomerView_Load(object sender, System.EventArgs e)
        {
            ...
            dt = oMySql.GetDataView(String.Format("SELECT CardSetID, Start, End, TotalCredit FROM WLOT.cart_cardsets"), "CardSet");
        ...
        private void DataGrid_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (Grid.ActiveRow != null)
                {
                    sSelectedID = Grid.ActiveRow.Cells["CardSetID"].Text;
