...
namespace Signature
{
	...
	/// </summary>
	public class frmShortagesView : System.Windows.Forms.Form
    {
        ...
        public frmShortagesView(String sCompanyID,String _CustomerID,String _OrderID)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ShortageID");
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("OrderID", 2);
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Name", 3);
            ...
            ultraGridColumn3.Header.Caption = "School ID";
            ...
            this.Name = "frmShortagesView";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Shortage View";
            this.TopMost = true;
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
            ...
            if (OrderID.Trim() != "")
                dt = oMySql.GetDataView(String.Format("Select ShortageID, CustomerID, OrderID, Name, City, Detail  from Shortage  Where CompanyID='{0}' And OrderID='{1}'", sCompanyID,OrderID), "Tmp");
            else if (CustomerID.Trim() != "")
                dt = oMySql.GetDataView(String.Format("Select ShortageID, CustomerID, OrderID, Name, City, Detail  from Shortage  Where CompanyID='{0}' And CustomerID='{1}' And OrderID='0'", sCompanyID, CustomerID), "Tmp");
            else
                dt = oMySql.GetDataView(String.Format("Select ShortageID, CustomerID, OrderID, Name, City, Detail  from Shortage  Where CompanyID='{0}'",sCompanyID), "Tmp");
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    if (Grid.Rows.Count > 0)
                    {
                        ...
                        if (Grid.ActiveRow != null)
                            sSelectedID = Grid.ActiveRow.Cells["ShortageID"].Text;
                        this.Close();
		...
		private void txtSearch_TextChanged_1(object sender, System.EventArgs e)
		{
            ...
            //dt.RowFilter = fld1 + " like '*" + txtSearch.Text + "*'";
			Grid.DataSource = dt;
