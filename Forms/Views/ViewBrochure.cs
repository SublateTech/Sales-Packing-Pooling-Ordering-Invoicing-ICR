...
namespace Signature
{
	...
	/// </summary>
	public class frmBrochureView : System.Windows.Forms.Form
	{
		...
		public frmBrochureView(String sCompanyID)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "frmBrochureView";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "BrochureView";
		...
		private void frmCustomerView_Load(object sender, System.EventArgs e)
		{
			...
			dt = oMySql.GetDataView("Select d.BrochureID,d.Description from Brochure d Where CompanyID='"+sCompanyID+"'","Brochures");
            this.Text = "Brochure View";
			//
		...
		*/	
            ...
            Col_01.HeaderText = "Brochure ID";
            Col_01.MappingName = "BrochureID";
            Col_01.Width = 45;
            Col_01.NullText = "";
