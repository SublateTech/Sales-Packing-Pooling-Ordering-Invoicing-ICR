...
using Signature.SpellChecker;

namespace Signature.SpellChecker.Forms
{
	/// <summary>
	...
	public class SuggestionForm : System.Windows.Forms.Form
	{
        ...
        private Signature.SpellChecker.Spelling SpellChecker;
		...
		{
			this.SpellChecker.ReplaceWord(this.ReplacementWord.Text.ToUpper());
			this.TextBeingChecked.Text = this.SpellChecker.Text.ToUpper();
			this.SpellChecker.SpellCheck();
		}
        ...
        private void SpellChecker_DoubledWord(object sender, Signature.SpellChecker.SpellingEventArgs e)
		{
        ...
        private void SpellChecker_MisspelledWord(object sender, Signature.SpellChecker.SpellingEventArgs e)
		{
			this.UpdateDisplay(this.SpellChecker.Text, e.Word, 
				e.WordIndex, e.TextIndex);
