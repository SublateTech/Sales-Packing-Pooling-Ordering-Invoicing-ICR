<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmOrderItem_1.aspx.cs" Inherits="Signature.Campaign.frmOrderItem_1" %>
                                   ...
                                   <table style="width: 100%; height: 35px;">
                                       ...
                                       <tr>
                                           ...
                                           <td colspan="5" align="right" >
                                               <igtbl:UltraWebGrid ID="txtItems" runat="server" Height="100px" 
                                                   Width="663px">
                                                   <bands>
                                                       <igtbl:UltraGridBand ColHeadersVisible="Yes" GroupByColumnsHidden="Yes">
                                                           <Columns>
                                                               <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="ProductID" 
                                                                   ...
                                                                   <valuelist datamember="idRequest" displaymember="idRequest">
                                                                   </valuelist>
                                                                   <header caption="Item">
                                                                   </header>
                                                               </igtbl:UltraGridColumn>
                                                               <igtbl:UltraGridColumn AllowUpdate="No" BaseColumnName="Description" 
                                                                   IsBound="True" Key="Description" Width="250px">
                                                                   <valuelist datamember="patientName" displaymember="patientName">
                                                                   </valuelist>
                                                               ...
                                                               <igtbl:UltraGridColumn Key="Retail" BaseColumnName="Retail" 
                                                                   HeaderClickAction="Select">
                                                                   <Header Caption="Minumum Donation Amount" ClickAction="Select">
                                                               ...
                                                               <igtbl:UltraGridColumn BaseColumnName="Quantity" Key="Quantity">
                                                               ...
                                                               <igtbl:UltraGridColumn CellButtonDisplay="Always" Key="Delete" Type="Button">
                                                                   <Header Caption="Delete" TitleMode="Always">
                                                                       <RowLayoutColumnInfo OriginX="4" />
                                                                   </Header>
                                                                   <Header Caption="Reject" TitleMode="Always">
                                                   ...
                                                   <displaylayout allowcolsizingdefault="Free" allowcolumnmovingdefault="OnServer" 
                                                       ...
                                                       <framestyle backcolor="Window" bordercolor="InactiveCaption" 
                                                           ...
                                                           font-size="8.25pt" height="100px" width="663px">
                                                       </framestyle>
                                       ...
                                       <tr>
                                           ...
                                           <td align="center" colspan="5">
                                               <asp:PlaceHolder ID="OrderDetail" runat="server"></asp:PlaceHolder>
                                           </td>
                                           <td align="center" class="style22">
                                               &nbsp;</td>
                                       </tr>
                                       ...
                                       <tr>
                                           ...
                                           <td align="right" class="style22" valign="bottom">
                                               <asp:Button ID="butAddMoney" runat="server" onclick="butAddItem_Click" 
                                                   text="Add" Width="63px" />
                                           </td>
                                           <td class="style19">
                                               &nbsp;</td>
